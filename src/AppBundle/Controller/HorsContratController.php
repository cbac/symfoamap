...
use AppBundle\Entity\Amap\HorsContrat;
use AppBundle\Form\HorsContratType;
...
class HorsContratController extends Controller
{
    ...
    public function listAction()
    {
    	...
    	$horscontrats = $em->getRepository('AppBundle:Amap\HorsContrat')->findAll();
    ...
    public function newHorsContratAction(Request $request) {
    	$horscontrat = new HorsContrat ();
	   	...
	   	$form = $this->createForm ( 'AppBundle\Form\HorsContratType', $horscontrat );
    ...
    public function editHorsContratAction(Request $request, HorsContrat $horscontrat) {
    	$deleteForm = $this->createDeleteForm ( $horscontrat );
    	$editForm = $this->createForm ( 'AppBundle\Form\HorsContratType', $horscontrat );
