 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Amap\ProduitRepository")
 */
class Produit
{
    /**
     ...
     * Add contrat
     *
     * @param \AppBundle\Entity\Amap\Contrats $contrat
     *
     * @return Produit
     */
    public function addContrat(\AppBundle\Entity\Amap\Contrat $contrat)
    {
     ...
     * @param \AppBundle\Entity\Amap\Contrats $contrat
     */
    public function removeContrat(\AppBundle\Entity\Amap\Contrat $contrat)
    {
